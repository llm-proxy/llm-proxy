...
class LLMProxy:
    ...
    def _cost_route(self, prompt: str):
        ...
        while not completion_res:
            ...
            try:
                completion_res = self._make_provider_call(prompt, instance_data)
    ...
    def _make_provider_call(
        self, prompt: str, instance_data: List[Any]
    ) -> CompletionResponse:
        """
        ...
        Returns:
            CompletionResponse: The response generated by the model.
        """
        import logging
