...
#     # Arrage
#     prompt = "How do write a python script that prints the numbers 1 through 10?"
#     # Act
#     category = categorization.categorize_text(prompt=prompt)
#     # Assert
#     assert category == "Code Generation Task"
