...
def test_llama2_emp_prompt() -> None:
    llama2_emp_promt = Llama2(prompt="",system_prompt=default_system_prompt,model=default_model)
    output = llama2_emp_promt.get_completion()
    assert output.message == "No prompt detected"

def test_llama2_api_key() -> None:
    test_api_key= Llama2(prompt=default_prompt,system_prompt=default_system_prompt,api_key="LMAO-key",model=default_model)
...
def test_llama2_model() -> None:
    test_model_1 = Llama2(prompt=default_prompt,system_prompt=default_system_prompt,api_key=default_api_key,model=Llama2Model.LLAMA_2_7B.value)
    test_model_2 = Llama2(prompt=default_prompt,system_prompt=default_system_prompt,api_key=default_api_key,model=Llama2Model.LLAMA_2_13B.value)
    test_model_3 = Llama2(prompt=default_prompt,system_prompt=default_system_prompt,api_key=default_api_key,model=Llama2Model.LLAMA_2_70B.value)
...
def test_llama2_emp_model() -> None:
    test_emp_model = Llama2(prompt=default_prompt,system_prompt=default_system_prompt,api_key=default_api_key,model="")
    output = test_emp_model.get_completion()
    
    assert output.message == "Invalide Model. Please use one of the following model: Llama-2-7b-chat-hf, Llama-2-13b-chat-hf, Llama-2-70b-chat-hf"