...
#     classifier = pipeline(task="zero-shot-classification", model="facebook/bart-base")
...
# prompt = (
#     "I want to write python code that converts even numbers to odd and multiplies by 2"
# )
# res, best_category = get_best_category(prompt=prompt, candidate_labels=candidate_labels)
# print(res)
# print(best_category)
...
classifier = pipeline(
    task="sentiment-analysis", model="siebert/sentiment-roberta-large-english"
)
